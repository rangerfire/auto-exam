...
<%
    ...
    if(request.getParameter("root")==null || !request.getParameter("root").toString().equals("cha")){
        response.sendRedirect("cha.jsp?root=cha");
        return;
    }
    int i = 0;
    try {
    ...
    String[] header_list = new String[]{"用户修改", "题库修改"};
%>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <%if (i == 0) {%>
            <jsp:include page="template/cha-0.htm"></jsp:include>
            <%}else if(i==1){%>
            <jsp:include page="template/cha-1.jsp"></jsp:include>
            <%}%>
